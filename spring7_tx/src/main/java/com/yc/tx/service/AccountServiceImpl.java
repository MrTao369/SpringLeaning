...
public class AccountServiceImpl implements AccountService {
    ...
    @Override
    public Accounts transfer(Accounts a, Accounts b, double money) {
        String uid = UUID.randomUUID().toString();   //转账流水
        this.deposite(a, money, OpTypes.transfer.getName(), uid);
        Accounts newAccounts = this.withdraw(b, money, OpTypes.transfer.getName(), uid);
        return newAccounts;
    }
